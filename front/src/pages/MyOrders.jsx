...
// const [helpOrderId, setHelpOrderId] =
//   useState(null);

// const [helpItem, setHelpItem] =
//   useState(null);
...
// const [reviewBookId, setReviewBookId] =
//   useState(null);
...
//   console.log(
//     "CANCEL FUNCTION RUNNING"
//   );

//   try {

//     await axios.put(
//       `http://localhost:5000/order/cancel-return/${helpOrderId}`,
//       {
//         bookId:
//           helpItem.bookId?._id,
//       }
...
//     const res =
//       await axios.get(
//         `http://localhost:5000/book/${bookId}`
//       );
...
//   `http://localhost:5000/book/${reviewBookId}/review`,
//   {
//     userId: user._id,
...
//       await axios.put(
//         `http://localhost:5000/order/return/${returnOrderId}`,
//         {
//           returnReason,
//           refundType,
...
// return (
//   <  div className="max-w-6xl mx-auto p-6 text-slate-800 dark:text-white">
...
//         className="w-full p-3 rounded-lg text-white bg-gray-200 dark:bg-slate-700 border border-slate-600 focus:outline-none focus:border-pink-500"
//         rows="4"
//       />
...
//     <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl w-[90%] max-w-lg">
...
function MyOrders() {
  ...
  const handleSubmitReview = async () => {
    try {
      const user = JSON.parse(localStorage.getItem("User"));
      await axios.post(`http://localhost:5000/book/${reviewBookId}/review`, {
        userId: user._id,
        userName: user.fullname,
        rating,
        comment,
